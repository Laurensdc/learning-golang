...
func TestDecodeInstruction_Single_Reg_To_Reg(t *testing.T) {
	t.Skip("passes")
...
func TestDecodeInstruction_RegMemToFromReg_RegisterMode_11(t *testing.T) {
	t.Skip("passes")
...
func TestDecodeInstruction_RegMemToFromReg_MemoryMode_00(t *testing.T) {
	t.Skip("passes")
...
func TestDecodeInstruction_RegMemToFromReg_MemoryMode_01_8BitDisplacement(t *testing.T) {
	t.Skip("Failing")
...
func TestDecodeInstruction_RegMemToFromReg_MemoryMode_10_16BitDisplacement(t *testing.T) {
	t.Skip()

	input := []byte{0b10001010, 0b10000000, 0b10000111, 0b00010011, 0b10001001, 0b00001001, 0b10001000, 0b00001010, 0b10001000, 0b01101110, 0b00000000}
	output := DecodeInstructions(input)
...
func TestDecodeInstruction_ImmediateToRegister(t *testing.T) {
	t.Skip("passes")
...
func TestDecodeManyMore(t *testing.T) {
	t.Skip("Splitting this into subtests")
